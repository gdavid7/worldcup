...
_Full 350-market de-vig table archived in `predictions_summary_archive_2026-06.md` (this session applied no bias corrections — pure Kalshi/base-rate de-vig anchor for the whole tournament)._
...
**Totals:** 199 UPDATED, 188 SKIPPED (within 5pp), 387 markets. Source priority: Pinnacle/sharp → Kalshi → Polymarket → base rates. _Full per-market actions table archived in `predictions_summary_archive_2026-06.md`._
