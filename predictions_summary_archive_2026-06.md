# Probability Cup — Archived per-market session logs (June 2026)

Full per-market enumeration tables from the 2026-06-12 and 2026-06-20 sessions, moved out of `predictions_summary.md` on 2026-06-26 to keep the active file readable. Live market values come from the API, not these tables — kept here only for audit history.
